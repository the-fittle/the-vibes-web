...
import { sendCustomEmail as sendCustomEmailTransporter, sendTemplateEmail as sendTemplateEmailTransporter } from './transporter'
...
/**
 * HTTP Function: sendVerificationCode
...
export const sendVerificationCode = functions.https.onRequest( ( req, res ) =>
{
	corsHandler( req, res, async () =>
	{
		try
		{
			...
			{
				await sendTemplateEmailTransporter( {
					from: 'Vibes Support <support@mg.the-vibes.app>',
					template: 'sendVerificationCode',
					variables,
					recipients,
					recipientsVariables,
				} )
...
/**
 * HTTP Function: validateVerificationCode
 * Verifies the provided code for the specified recipient and creates a Firebase user.
 */
export const validateVerificationCode = functions.https.onRequest( ( req, res ) =>
{
	corsHandler( req, res, async () =>
	{
		try
...
export const sendCustomEmail = functions.https.onRequest( ( req, res ) =>
{
	corsHandler( req, res, async () =>
	{
		try
		{
			...
			await sendCustomEmailTransporter( {
				from,
				subject,
				variables,
				recipients,
 ...
 */
export const sendTemplateEmail = functions.https.onRequest(
	( req, res ) =>
	{
		corsHandler( req, res, async () =>
		{
