...
export class Modifier
{
    ...
    elevation = ( z: number, color: string = "rgba(0, 0, 0, 0.118)" ): Modifier =>
        this.css( "box-shadow", createShadowBlur( "0px", `${ z }px`, `${ z * 2 }px`, color ) );
...
// modifiers.ts or a separate utilities file

/** Create a box-shadow string with blur */
...
/** Create a box-shadow string with blur and spread */
